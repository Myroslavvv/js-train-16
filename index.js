...
function filterStudentsByGrade(students, grade) {
  ...
  let filter = students.filter(student => student.grade === grade);
...
function logArrayElements(arr) {
  ...
  if(!(Array.isArray(arr))) {
    ...
    arr.forEach((index, elem) => {
      console.log(`Елемент ${elem}: ${index}`)
      });
}
...
function warnAboutMaxArrayLength(arr, maxLength) {
  ...
  if(!(Array.isArray(arr)) || (typeof(maxLength) !== "number")) {
    console.log("Перший аргумент має бути масивом, другий аргумент має бути числом!");
    return null;
  }
  (arr.length > maxLength) ? console.warn("Увага! Довжина масиву перевищує максимально допустиму!") : console.info("Довжина масиву не перевищує максимально допустиму.")
}
...
function compareArrays(arr1, arr2) {
  ...
  let x = arr1.sort();
  let y = arr2.sort();
  let res1 = JSON.stringify(x);
  let res2 = JSON.stringify(y);

  console.assert(res1 === res2, "Масиви не однакові!");
}
...
function countVowelsAndConsonants(word) {
  ...
  for(let item of word) {
    ...
    // let resIncludes = word.includes(str);
    if(str.includes(res)) {
      a++;
    } else if(res >= "a" && res <= "z") {
      b++;
  ...
  console.log("голосні:", a);
  console.log("приголосні:", b);
}
